---
title: "보안걱정 없는 도커 컨테이너 격리 버전 OpenClaw A to Z 완벽 정리"
excerpt: "누구나 따라할 수 있는 높은 보안 수준의 OpenClaw 사용법"
...
![image.png](/assets/images/posts/openclaw-setting/image-2.png)

![image.png](/assets/images/posts/openclaw-setting/image-3.png)

- 저는 openAI의 Pro 플랜 사용중이라 Codex 인증을 진행하겠습니다. 가끔 인증 끝나면 오류창 뜨는데 오류창 링크 복사해서 붙여넣으면 됩니다.
- 저는 openai-codex/coxed 5.3 버전을 선택했습니다.
- 다시 `openclaw tui`  실행

![image.png](/assets/images/posts/openclaw-setting/image-4.png)
...
![image.png](/assets/images/posts/openclaw-setting/image-8.png)
